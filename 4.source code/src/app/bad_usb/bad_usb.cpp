...
namespace MOONCAKE::APPS
{
    ...
    void BadUSB::scanScripts()
    {
        ...
        while (f)
        {
            if (!f.isDirectory())
            {
                ...
                {
                    if (!n.startsWith("/badusb"))
                        n = String("/badusb/") + n; // Some platforms return relative names
    ...
    uint8_t BadUSB::keyFromName(const String &name, bool &isPrintable, uint8_t &printableChar)
    {
        ...
        if (n.equalsIgnoreCase("ENTER") || n.equalsIgnoreCase("RETURN"))
            return KEY_RETURN;
        if (n.equalsIgnoreCase("ESC") || n.equalsIgnoreCase("ESCAPE"))
            return KEY_ESC;
        if (n.equalsIgnoreCase("TAB"))
            return KEY_TAB;
        ...
        if (n.equalsIgnoreCase("UP"))
            return KEY_UP_ARROW;
        if (n.equalsIgnoreCase("DOWN"))
            return KEY_DOWN_ARROW;
        if (n.equalsIgnoreCase("LEFT"))
            return KEY_LEFT_ARROW;
        if (n.equalsIgnoreCase("RIGHT"))
            return KEY_RIGHT_ARROW;
        if (n.equalsIgnoreCase("F1"))
            return KEY_F1;
        if (n.equalsIgnoreCase("F2"))
            return KEY_F2;
        if (n.equalsIgnoreCase("F3"))
            return KEY_F3;
        if (n.equalsIgnoreCase("F4"))
            return KEY_F4;
        if (n.equalsIgnoreCase("F5"))
            return KEY_F5;
        if (n.equalsIgnoreCase("F6"))
            return KEY_F6;
        if (n.equalsIgnoreCase("F7"))
            return KEY_F7;
        if (n.equalsIgnoreCase("F8"))
            return KEY_F8;
        if (n.equalsIgnoreCase("F9"))
            return KEY_F9;
        if (n.equalsIgnoreCase("F10"))
            return KEY_F10;
        if (n.equalsIgnoreCase("F11"))
            return KEY_F11;
        if (n.equalsIgnoreCase("F12"))
            return KEY_F12;
        // Numbers and letters
        if (n.length() == 1 && isalnum((int)n[0]))
        {
            isPrintable = true;
            printableChar = (uint8_t)n[0];
            return 0;
    ...
    void BadUSB::execCommand(const String &raw)
    {
        ...
        if (matchToken(line, "GUI") || matchToken(line, "WINDOWS"))
        {
            ...
            {
                String k = line.substring(sp + 1);
                k.trim();
                bool printable = false;
                uint8_t ch = 0;
                uint8_t vk = keyFromName(k, printable, ch);
        ...
        // Example: F11 / UP / a b c
        {
            ...
            while (start < (int)line.length())
            {
                ...
                bool printable = false;
                uint8_t ch = 0;
                uint8_t vk = keyFromName(tok, printable, ch);
                if (printable)
                    Keyboard.write(ch);
                else if (vk)
                    Keyboard.write(vk);
