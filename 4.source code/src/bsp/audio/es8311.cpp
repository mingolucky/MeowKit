...
ES8311::ES8311(TwoWire* wire, uint8_t i2cAddr){
    _TwoWireInstance = wire;    // 修复：应该赋值wire参数，而不是未定义的TwoWireInstance
    _i2cAddr = i2cAddr;
    _mclk_hz = 0; // MCLK frequency in Hz, will be set in begin()       
}
